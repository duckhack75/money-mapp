...
public class SalidaInversion {
    ...
    public SalidaInversion() {
    }

    public SalidaInversion(String correo, String negocios, String bienesRaices, String bolsaValores,
                           String metales, String propiedadIntelectual, String proteccion, String otrasInversiones, String totalInversiones) {
        this.correo = correo;
